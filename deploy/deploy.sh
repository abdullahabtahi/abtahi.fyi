...
FIREBASE_API_KEY="${FIREBASE_API_KEY:-AIzaSyAZgvaDjk3S66E2ZRXoeGXJWv9zeJB5Rcg}"
FIREBASE_AUTH_DOMAIN="${FIREBASE_AUTH_DOMAIN:-spatial-cat-489006-a4.firebaseapp.com}"
FIREBASE_PROJECT_ID="${FIREBASE_PROJECT_ID:-spatial-cat-489006-a4}"
FIREBASE_APP_ID="${FIREBASE_APP_ID:-1:903682941870:web:5dbd7f74136f2e129d5e3f}"
FIREBASE_STORAGE_BUCKET="${FIREBASE_STORAGE_BUCKET:-spatial-cat-489006-a4.firebasestorage.app}"
